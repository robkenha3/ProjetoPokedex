// import { arrayTypes } from "../../api/api.js";
// export { arrayTypes };
...
export const arrayTypes = [
    ...
    },
    {
        id: 16,
        type: "Escuridão",
        img: "/assets/img/backgrounds/background-dark.png",
        attackProsCons: {
            superEffective: ["Psíquico", "Fantasma"],
            notVeryEffective: ["Lutador", "Escuridão", "Fada"],
        },
        defenseProsCons: {
            noEffect: ["Psíquico"],
            notVeryEffective: ["Fantasma", "Escuridão"],
            superEffective: ["Lutador", "Inseto", "Fada"],
        }
    ...
    },
    {
        id: 17,
        type: "Ferro",
        img: "/assets/img/backgrounds/background-steel.png",
        attackProsCons: {
            superEffective: ["Gelo", "Pedra", "Fada"],
            notVeryEffective: ["Fogo", "Água", "Elétrico", "Ferro"],
        },
        defenseProsCons: {
            noEffect: ["Veneno"],
            notVeryEffective: ["Normal", "Grama", "Gelo", "Voador", "Psíquico", "Inseto", "Pedra", "Dragão", "Ferro", "Fada"],
            superEffective: ["Fogo", "Lutador", "Terra"],
        }
